...
namespace C__Project
{
    public partial class Form7 : Form
    {
        ...
        public Form7()
        {
            ...
            unIncludeButtons = new List<Button> { UnInclude1, UnInclude2, UnInclude3, UnInclude4, UnInclude8, UnInclude9, UnInclude10, UnInclude11 };
            includeButtons = new List<Button> { Include1, Include2, Include3, Include4, Include8, Include9, Include10, Include11, Include14 };
            ...
            bs = new ChangeButtonSystem(
                 new List<Button> { UnInclude1, UnInclude2, UnInclude3, UnInclude4, UnInclude7 },
                 new List<Button> { Include1, Include2, Include3, Include4, Include7 },
                 new List<Button> { UnInclude8, UnInclude9, UnInclude10, UnInclude11, UnInclude14 },
                 new List<Button> { Include8, Include9, Include10, Include11, Include14 },
                 new List<Button> { NoTax, Tax3_3, Tax9_8 }
            );

            chw = new ChangeHW(new List<TextBox> { HW1, HW2, HW3, HW4 });
            hour = new ChangeHour(new List<TextBox> { DH1, DH2, DH3, DH4 },
                   new List<TextBox> { Day1, Day2, Day3, Day4, }
            );
