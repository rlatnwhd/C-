...
namespace C__Project
{
    public partial class Form2 : Form
    {
        ...
        public Form2()
        {
            ...
            unIncludeButtons = new List<Button> { UnInclude1, UnInclude2, UnInclude3, UnInclude4, UnInclude5, UnInclude6, UnInclude8, UnInclude9, UnInclude10, UnInclude11, UnInclude12, UnInclude13 };
            includeButtons = new List<Button> { Include1, Include2, Include3, Include4, Include5, Include6, Include8, Include9, Include10, Include11, Include12, Include13, Include14 };
            ...
            bs = new ChangeButtonSystem(
                 new List<Button> { UnInclude1, UnInclude2, UnInclude3, UnInclude4, UnInclude5, UnInclude6, UnInclude7 },
                 new List<Button> { Include1, Include2, Include3, Include4, Include5, Include6, Include7 },
                 new List<Button> { UnInclude8, UnInclude9, UnInclude10, UnInclude11, UnInclude12, UnInclude13, UnInclude14 },
                 new List<Button> { Include8, Include9, Include10, Include11, Include12, Include13, Include14 },
                 new List<Button> { NoTax, Tax3_3, Tax9_8 }
            );

            chw = new ChangeHW(new List<TextBox> { HW1, HW2, HW3, HW4, HW5, HW6 });
            hour = new ChangeHour(new List<TextBox> { AH1, AH2, AH3, AH4, AH5, AH6 },
                   new List<TextBox> { DH1, DH2, DH3, DH4, DH5, DH6 },
                   new List<TextBox> { Day1, Day2, Day3, Day4, Day5, Day6 }
            );
