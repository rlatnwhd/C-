...
namespace C__Project
{
    public partial class Form10 : Form
    {
        ...
        public Form10()
        {
            ...
            unIncludeButtons = new List<Button> { UnInclude8, UnInclude9, UnInclude10, UnInclude11 };
            includeButtons = new List<Button> { Include8, Include9, Include10, Include11 };
            ...
            bs = new ChangeButtonSystem(
                 new List<Button> { UnInclude7, UnInclude8, UnInclude9, UnInclude10, UnInclude11 },
                 new List<Button> { Include7, Include8, Include9, Include10, Include11 },
                 new List<Button> { },
                 new List<Button> { },
