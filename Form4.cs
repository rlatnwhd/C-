    ...
    public partial class Form4 : Form
    {
        ...
        public Form4()
        {
            ...
            bs = new ChangeButtonSystem(
                 [UnInclude1, UnInclude2, UnInclude3, UnInclude4, UnInclude7],
                 [Include1, Include2, Include3, Include4, Include7],
                 [UnInclude8, UnInclude9, UnInclude10, UnInclude11, UnInclude14],
                 [Include8, Include9, Include10, Include11, Include14],
                 [NoTax, Tax3_3, Tax9_8]
            );

            chw = new ChangeHW([HW1, HW2, HW3, HW4]);
            hour = new ChangeHour([AH1, AH2, AH3, AH4],
                   [DH1, DH2, DH3, DH4],
                   [Day1, Day2, Day3, Day4]
            );
        ...
        private void DH1_TextChanged(object sender, EventArgs e)
        {
            TextBox textBox = sender as TextBox;
